...
pub const INDICES: &[u16] = &[
    ...
    4, 5, 6, 6, 7, 4, // Top face (vertices 8-11)
    8, 9, 10, 10, 11, 8, // Bottom face (vertices 12-15)
    12, 13, 14, 14, 15, 12, // Right face (vertices 16-19)
    16, 17, 18, 18, 19, 16, // Left face (vertices 20-23)
    20, 21, 22, 22, 23, 20,
];
